#!/usr/bin/env bash
# Train hybrid_coatmini on fold0 with focal_weighted loss — controlled experiment.
# Everything except loss is identical to train_hybrid_fold0.sh for direct comparability.
